/************************ * Tentativeonline - RESTORED WORKING VERSION
...
function trialsLoopBegin(scheduler, fileName, blockName) {
    return async function() {
        ...
        let trials = new TrialHandler({ psychoJS, nReps: 1, method: TrialHandler.Method.SEQUENTIAL, trialList: selectedConditions, name: blockName });
...
function routineBegin(thisTrial, blockName) {
    return async function () {
        ...
        // --- Torniamo ai nomi delle colonne di ieri: image_file ---
...
async function quitPsychoJS() {
    ...
    psychoJS.experiment.save(); // Backup local download
