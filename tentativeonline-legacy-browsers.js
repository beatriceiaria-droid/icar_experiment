...
let expName = 'tentativeonline';  // from the Builder filename that created this script
let expInfo = {
...
function routine_VR_trialRoutineBegin(snapshot) {
  return async function () {
    ...
    routine_VR_trialComponents.forEach( function(thisComponent) {
...
function routine_LN_trialsRoutineBegin(snapshot) {
  return async function () {
    ...
    routine_LN_trialsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function routine_3DR_trialRoutineBegin(snapshot) {
  return async function () {
    ...
    routine_3DR_trialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function routine_MX_trialRoutineBegin(snapshot) {
  return async function () {
    ...
    routine_MX_trialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function DataSavingRoutineBegin(snapshot) {
  return async function () {
    ...
    DataSavingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
